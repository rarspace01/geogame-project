...
Geogames sind eine Spezialisierung von ortsbezogener Spiele, welche als Ursprung meist ein Brettspiel haben.
Geogames sind nicht begrenzt auf digitale Spiele, sondern haben Ihren Ursprung im Versteckspiel, auch in der Form als Schnitzeljagd. Ein späterer Nachfolger dieser stellt das Geocaching dar.\cite{Simanowski.2008}
...
Hierbei findet die Steuerung der Spiels und somit der Spielerposition durch Locomotion statt.\cite{Benford.2003,Kiefer.2007}
...
Anhand dieser Spieler wurden Erkenntnisse in der Praxis gewonnen, welche sich in Teilen mit der Gamification Literatur in Kapitel \ref{sec:S3_Gamification} decken.
...
In der Literatur werden die Probleme von ortsbezogenen Spielen öfters angesprochen, jedoch keine konkreten Lösungsansätze angesprochen.
...
Hefting domains stellen die Problematik dar, dass Spielelemente in Computerspielen auf die virtuellen Spielwelt fokusiert sind. Bei Pervasive Games muss dagegen ein besonderer Wert auf die Designentscheidungen bezüglich der virtuellen, reellen und hybriden Spielelemete gelegt werden.
