...
Hierbei soll aufgezeigt werden, wie eine Interaktion des Kunden vor Ort beim Dienstleister aussehen kann. Eine konkrete Evaluation der Effekte durch das Framework ist nicht Bestandteil der Arbeit.
...
Durch die Verwendung der Gamification Elemente, die durch das Framework zur Verfügung gestellt werden, soll das Spiel entsprechend aufgewertet werden. Dadurch ist es notwendig, gewisse Entscheidungen bezüglich des Spielcontent als auch der Spielmechanik zu machen.
