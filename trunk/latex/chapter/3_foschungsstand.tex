...
\caption{Flow Zustand nach  nach \cite{Csikszentmihalyi.1991} - Bild ersetzten}
...
Als Ergebnis wird angenommen, dass spatial discrete Spiele eine einfache\begin{figure}[H]
\begin{center}
\includegraphics[width=120mm]{images/ch03_img02_flow.jpg}
\caption{Flow Zustand nach  nach \cite{Csikszentmihalyi.1991}}
\label{img:ch03_img02_flow}
\end{center}
\end{figure}re Konfiguration erlauben wie unter anderem \cite{Benford.2005} angemerkt hat.
...
// Kurze generelle Info zum Aufbau von OSM? Bild  von Relations Ways und Nodes?
...
\section{Geostatistik}
\label{subsec:S3_geostatistik}

-Kapitel folgt später