...
Die Verwendung von Git wurde in Erwägung gezogen, aber Aufgrund der Tatsache, dass das Projekt nur einen Entwickler besitzt, wurde dies als unproblematisch angesehen. Ein späterer Transfer in ein Git-Projekt ist problemlos mit 'git-svn clone' und weiteren Anpassungen möglich. Dieser ist auch zu empfehlen, wenn das Framework später mit mehreren Entwicklern weiterentwickelt wird.
